...
// get a simple category from store name keywords
function guessCategory(name) {
  const n = name.toLowerCase();
  if (n.includes("apotek") || n.includes("hälso") || n.includes("life natur"))
    return "Health & Pharmacy";
  if (
    n.includes("optik") ||
    n.includes("synsam") ||
    n.includes("specsavers") ||
    n.includes("synoptik") ||
    n.includes("smarteyes")
  )
    return "Optician";
  if (
    n.includes("sko") ||
    ...
    return "Shoes";
  if (n.includes("tatoo") || n.includes("tattoo") || n.includes("bläck"))
    return "Tattoo & Body Art";
  if (
    n.includes("guld") ||
    n.includes("smycke") ||
    n.includes("ur &") ||
  ...
  if (
    n.includes("second hand") ||
    n.includes("nytt & bytt") ||
    n.includes("pmu")
  )
    return "Second Hand";
  if (
    ...
    n.includes("ica") ||
    n.includes("livs") ||
    n.includes("systembolaget") ||
    n.includes("vätterfisk")
  )
    return "Food & Drink";
  if (
    n.includes("resehuset") ||
    n.includes("ticket") ||
    n.includes("forex") ||
    n.includes("resecentrum")
  )
  ...
  if (
    n.includes("fritid") ||
    n.includes("dive") ||
    n.includes("boardlife") ||
    n.includes("golden athlete") ||
    n.includes("sunoff")
  )
    return "Sports & Outdoor";
  if (
    n.includes("inredning") ||
    n.includes("hemtex") ||
    n.includes("lagerhaus") ||
    n.includes("cervera") ||
    n.includes("nordisk möbel") ||
    n.includes("kvänum") ||
    n.includes("hemmakväll")
  )
  ...
  if (
    ...
    return "Art & Gallery";
  if (n.includes("brud") || n.includes("fest") || n.includes("party"))
    return "Bridal & Party";
  if (
    n.includes("skrädderi") ||
    n.includes("sycenter") ||
    n.includes("skomakeri") ||
    n.includes("kemtvätt")
  )
